...
const AppFooter: React.FC<AppFooterProps> = ({
  ...
  return (
    <MediaQuery largerThan="sm" styles={{ display: "none" }}>
      <Footer
        p="md"
        height={screenIsThin ? 100 : 0}
        sx={{ backgroundColor: colorSchemeIsLight ? "white" : "black" }}
      >
        <Group position="apart">
          <Group position="left">
            <ActionIcon
              ...
              color={
                theme.colors[theme.primaryColor][theme.fn.primaryShade() - 4]
              }
            >
              <FontAwesomeIcon icon={faBars} />
            </ActionIcon>
          </Group>
          <Group position="center" spacing="xl" sx={{ height: "100%" }}>
            <ActionIcon
              size="xl"
              radius="xl"
              component={Link}
              href={`/squads/${squadId}/members`}
            ...
            >
              ...
              >
                <path
                  ...
                  stroke={colorSchemeIsLight ? "black" : "white"}
                  strokeWidth="1.5"
                  strokeLinecap="round"
